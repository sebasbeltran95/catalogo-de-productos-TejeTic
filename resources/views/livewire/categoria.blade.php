                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="@error('nombre_categoria') text-danger @enderror">Nombre Categorias</label>
                            <input type="text" class="form-control @error('nombre_categoria') text-danger @enderror" wire:model="nombre_categoria">
                            <i class="text-danger">
                                @error('nombre_categoria') {{ $message }} @enderror
                            </i>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="Modaleditar" tabindex="-1" wire:ignore.self>
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label class="@error('nombre_categoriax') text-danger @enderror">Nombre Categoria</label>
                                        <input type="text" class="form-control @error('nombre_categoriax') text-danger @enderror" wire:model="nombre_categoriax">
                                        <i class="text-danger">
                                            @error('nombre_categoriax') {{ $message }} @enderror
                                        </i>
                                    </div>
                                </div>
                                <div class="modal-footer">
        ...
        livewire.on('deletePost', postId => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    livewire.emitTo('categoria', 'delete', postId);
